...
<meta name=""author content="Phuong Thu"/>
...
#### Thẻ script có 4 thuộc tính cơ bản
...
<html lang="en">
  ...
  <body>
    <script src="demo_javascript.js"></script>
  </body>
</html>
```

```js title='demo_javascript.js'
document.write("Hello Cao Thu Phuong.");
```
